...
public class DialogueParser : IGoogleParser
{
    ...
    public void Parse(string headerName, string token)
    {
        switch (headerName)
        {
            ...
            case "Диалог":
                //_dialogLines = ParserDialogtext(token);
                //_currentDialogueEventData.DialogLines = ParserDialogtext(token);
                break;

            case "Sound":
                _currentDialogueEventData.SoundLine = ParserDialogSound(token);
                break;
    ...
    private List<SoundLine> ParserDialogSound(string fmodPath)
    {
    ...
    //private List<UpdateDialogText> ParserDialogtext(string text)
    //{
    //    List<UpdateDialogText> dialogs = new List<UpdateDialogText>();
    //    UpdateDialogText dialogLine = null;
    //    string tempText = string.Empty;
    ...
    //            dialogLine = new UpdateDialogText();
